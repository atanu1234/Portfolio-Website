...
const About = () => {
  return (
    <section className="bg-green-100 text-gray-800 py-12 px-4 md:px-12 lg:px-24 w-screen">
        ...
        <div className="flex flex-col md:flex-row items-center mb-12">
          <div className="md:w-1/2 mb-6 md:mb-0">
            <img
              ...
              alt="Your Profile"
              className="w-48 h-48 md:w-64 md:h-64 rounded-full mx-auto object-cover"
            />
          </div>
